#FOSS Club — Tech Interview 2026

Submitted by: Shreya Ajith

A fully enhanced and redesigned website for the FOSS Club of LBS Institute of Technology for Women. 
...
```
->Click the Fork button (top-right) to copy it to your own GitHub account.
